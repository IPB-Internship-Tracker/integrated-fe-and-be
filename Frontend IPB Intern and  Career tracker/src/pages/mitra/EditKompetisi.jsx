...
const EditKompetisi = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center py-5">
      ...
      {/* FORM EDIT */}
      <CreateProgramForm
        key={`kompetisi-${id}-${JSON.stringify(initialData)}`}
        title="Kompetisi"
        ...
        category="lomba"
        programId={id}
        storageKey={`edit_kompetisi_form_${id}`}
      />
            ...
            const save = async () => {
              ...
              try {
                ...
                if (isDraft) {
                  ...
                  await kegiatanService.updateLomba(
                    id,
                    formData
                  );
                }
      ...
      <PopUpNotif
        ...
        description={
          isDraft
            ? "Program kompetisi berhasil dipublikasikan."
